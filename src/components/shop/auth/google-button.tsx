...
function Inner({ label }: { label: string }) {
  ...
  return (
    <button
      type="submit"
      disabled={pending}
      className="flex h-11 w-full items-center justify-center gap-2.5 rounded-full border border-border bg-surface text-sm font-medium text-cocoa transition-colors hover:bg-cream-2 disabled:opacity-60"
    >
